...
const seo = {
  title: "Mohammedrasik's Portfolio",
  description:
...
//Home Page
const greeting = {
  title: "Mohammedrasik Shahul",
  logo_name: "MohammedrasikShahul",
  nickname: "",
  subTitle:
    "A passionate individual who always thrives to work on end to end products which develop sustainable and scalable social and technical systems to create impact.",
  resumeLink:
...
const socialMediaLinks = [
  ...
  {
    name: "Outlook",
    link: "mailto:rasik.shahul@outlook.com",
    fontAwesomeIcon: "fa-microsoft", // Reference https://fontawesome.com/icons/google?style=brands
    backgroundColor: "#3795d4", // Reference https://simpleicons.org/?q=gmail
  },
  // {
  //   name: "Twitter",
  ...
  data: [
    ...
    // },
    {
      ...
      softwareSkills: [
        ...
        {
          skillName: "D3.js",
          fontAwesomeClassname: "simple-icons:d3-dot-js",
          style: {
            color: "#F9A03C",
          },
        },
        {
          skillName: "Chart.js",
          fontAwesomeClassname: "simple-icons:chart-dot-js",
          style: {
            color: "#FF6384",
          },
        },
    ...
    },
    {
      ...
      skills: [
        "⚡ Managing cloud infrastructure and services, application platform and environments management",
...
const degrees = {
  degrees: [
    {
      title: "Sona College of Technology, Salem — Bachelor’s of Engineering",
    ...
    {
      title: "Sri Vijay Vidyalaya MAT. HR. SEC. School, Hosur— High School",
...
const certifications = {
  certifications: [
    ...
    // },
    {
      ...
      certificate_link:
        "https://www.credly.com/badges/ede474e4-665f-4707-83f5-fe5bc6d81704?source=linked_in_profile",
      alt_name: "Microsoft",
      color_code: "#D83B0199",
    },
    // {
      ...
      experiences: [
        {
          ...
          description:
            "Developed a responsive & interactive  angular application that enables users to analyze, document, and re-architect legacy applications. Created complex, dynamic &  interactive data visualizations, dynamic UML diagrams and implemented online code editor feature that allows the user to edit or download them.",
          color: "#0879bf",
        },
        {
          title:
...
const contactPageData = {
  ...
  addressSection: {
    title: "Address",
    subtitle: "Hosur, Tamil Nadu, India",
    avatar_image_path: "address_image.svg",
    location_map_link: "https://goo.gl/maps/Ei2tLZGzhiKWCisaA",
  },
  phoneSection: {
    title: "Phone Number",
    subtitle: "+91 9865633617",
  },
};
